...
from voxelizer import perimeter
from voxelizer import slice
from voxelizer import stl_reader
from voxelizer.util import arrayToWhiteGreyscalePixel, padVoxelArray

def doVoxel(inputFilePath, outputFilePath, resolution):
